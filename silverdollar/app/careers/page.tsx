    ...
    <div className="mx-auto px-4 py-8 height-[80vh] min-h-[80vh]">
      <div className="text-center mt-20">
        ...
        <p className="text-lg text-gray-600 mb-6">
          At Silver Dollars we value our team and their vital contributions to making things happen! Here, you can find and apply to all of our available job postings. 
        </p>
