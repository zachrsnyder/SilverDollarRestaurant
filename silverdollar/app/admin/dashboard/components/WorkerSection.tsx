...
export default function WorkerSection() {
    ...
    return(
        ...
        <div className="flex items-center justify-between p-4 border-b border-white/10">
            ...
            <h3 className="text-sm md:text-lg font-sans font-bold ">Manage Workers</h3>
            </div>
        ...
        <div className='overflow-hidden'>
            <div 
                className={`transform transition-all duration-300 ease-in-out ${
                    isOpen ? 'translate-y-0 opacity-100' : '-translate-y-2 opacity-0 h-0'
                }`}
            >
    ...
    >
        ...
        <div className='flex justify-end'>
            ...
            <div className='rounded-md bg-blue-500 hover:bg-blue-300 transition-colors duration-300 px-3 py-2 cursor-pointer'
                onClick={async()=>{
